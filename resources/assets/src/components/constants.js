...
15.4.2 - Nos casos de informação inverídica prestada pelo ALUNO BENFICIADO no ato da inscrição.
...
16.5. Em caso de Cancelamento do curso dentro do prazo de 7 dias (direito de arrependimento – art. 49 do Código de Defesa do Consumidor), o CAPTADOR fará a devolução do valor pago, quando cabível, em conformidade com a legislação vigente, ressarcindo o valor pago pelo ALUNO BENEFICIADO, através da geração de um crédito que poderá ser convertido pelo ALUNO BENFICIADO em reembolso ou utilizado para uma contratação futura.
